    ...
    <div class="container">
      ...
      <ol class="text__o-list">
        <li class="text__o-list-item text__o-list-item--heading">
          ...
          <ol class="text__o-list">
            <li class="text__o-list-item">
              ...
              «{{ mainDomain.title }}» (далее
              –
              Администрация сайта), действует в отношении всей информации, которую сайт {{ mainDomain.domain }}, (далее
              –{{
                mainDomain.domain
              }})
              расположенный на доменном имени {{ mainDomain.domain }} (а также его субдоменах), может получить о
              Пользователе во время
              использования сайта {{ mainDomain.domain }}(а также его субдоменов), его программ и его продуктов.
            </li>
          </ol>
        </li>
        <li class="text__o-list-item text__o-list-item--heading">
          ...
          <ol class="text__o-list">
            ...
            <li class="text__o-list-item">
              «Сайт {{ mainDomain.domain }}» - это совокупность связанных между собой веб-страниц, размещенных в сети
              Интернет по
              уникальному адресу (URL): {{ mainDomain.domain }}, а также его субдоменах.
            </li>
            <li class="text__o-list-item">
              «Субдомены» - это страницы или совокупность страниц, расположенные на доменах третьего уровня,
              принадлежащие сайту {{ mainDomain.domain }}, а также другие временные страницы, внизу который указана
              контактная
              информация
              Администрации
            </li>
            <li class="text__o-list-item">
              «Пользователь сайта {{ mainDomain.domain }} » (далее Пользователь) – лицо, имеющее доступ к сайту
              {{ mainDomain.domain }}, посредством
              сети Интернет и использующее информацию, материалы и продукты сайта {{ mainDomain.domain }}.
            </li>
            <li class="text__o-list-item">
        ...
        <li class="text__o-list-item text__o-list-item--heading">
          ...
          <ol class="text__o-list">
            <li class="text__o-list-item">
              Использование сайта {{ mainDomain.domain }} Пользователем означает согласие с настоящей Политикой
            ...
            <li class="text__o-list-item">
              ...
              сайта {{ mainDomain.domain }}.
            </li>
            <li class="text__o-list-item">
              Настоящая Политика конфиденциальности применяется к сайту {{ mainDomain.domain }}. {{ mainDomain.domain }}
        ...
        <li class="text__o-list-item text__o-list-item--heading">
          ...
          <ol class="text__o-list">
            <li class="text__o-list-item">
              ...
              запросу
              Администрации при регистрации на сайте {{ mainDomain.domain }}, при подписке на информационную e-mail
              рассылку или при
              оформлении заказа.
            </li>
            <li class="text__o-list-item">
              Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности,
              предоставляются Пользователем путём заполнения форм на сайте {{ mainDomain.domain }} и включают в себя
              следующую
              информацию:
            </li>
            <li class="text__o-list-item">
            ...
            <li class="text__o-list-item">
              {{ mainDomain.domain }} защищает Данные, которые автоматически передаются при посещении страниц:
              <br/>
              - IP адрес;
              <br/>
            ...
            <li class="text__o-list-item">
              {{ mainDomain.domain }} осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация
              используется с
        ...
        <li class="text__o-list-item text__o-list-item--heading">
          ...
          <ol class="text__o-list">
            ...
            <li class="text__o-list-item">
              ...
              использования сайта {{ mainDomain.domain }}, оказания услуг и обработки запросов и заявок от Пользователя.
            </li>
            <li class="text__o-list-item">
        ...
        <li class="text__o-list-item text__o-list-item--heading">
          ...
          <ol class="text__o-list">
            ...
            <li class="text__o-list-item">
              ...
              сайта {{ mainDomain.domain }}, и давать согласие на их обработку.
            </li>
            <li class="text__o-list-item">
        ...
        <li class="text__o-list-item text__o-list-item--heading">
          ...
          <ol class="text__o-list">
            ...
            <li class="text__o-list-item">
              ...
              данными, тексты и т. д.), к которой он может иметь доступ как к части сайта {{ mainDomain.domain }}, несет
              лицо,
              предоставившее
              такую информацию.
            </li>
            <li class="text__o-list-item">
              Пользователь соглашается, что информация, предоставленная ему как часть сайта {{ mainDomain.domain }},
              может являться
              объектом интеллектуальной собственности, права на который защищены и принадлежат другим Пользователям,
              партнерам
              или рекламодателям, которые размещают такую информацию на сайте {{ mainDomain.domain }}.
            ...
            <li class="text__o-list-item">
              ...
              {{ mainDomain.domain }}) допускается их распространение при условии, что будет дана ссылка на
              {{ mainDomain.domain }}.
            </li>
            <li class="text__o-list-item">
              ...
              коммуникационных данных, содержащихся на сайте {{ mainDomain.domain }} или передаваемых через него.
            </li>
            <li class="text__o-list-item">
            ...
            <li class="text__o-list-item">
              ...
              {{ mainDomain.domain }}, включая, но не ограничиваясь: информацию, защищенную авторским правом, без
              прямого согласия
              владельца
              авторского права.
            </li>
